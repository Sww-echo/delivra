...
<template>
  <main class="login-page">
    <section class="top-view">
      <button class="language" type="button" @click="showLanguage = true">
        <span>简体中文</span>
    ...
    <section class="content-view">
      ...
      <van-form class="login-form" @submit="login">
        <van-field v-model="email" name="email" placeholder="请输入邮箱" clearable />
      ...
      <div class="login-links">
        ...
        <button type="button" @click="router.push('/auth/forgot/email')">忘记密码</button>
      </div>

      <div class="switch-row">
        <button type="button" class="switch-item" @click="router.push('/auth/login/phone')">
          <span class="switch-icon muted"><van-icon name="phone-o" /></span>
          <em>手机号</em>
        </button>
        <button type="button" class="switch-item">
          <span class="switch-icon active"><van-icon name="envelop-o" /></span>
          <em>邮箱</em>
        </button>
      </div>
    ...
    <van-action-sheet :show="showLanguage" :actions="[{ name: '简体中文' }, { name: 'English' }]" @update:show="showLanguage = $event" @select="showLanguage = false" />
  </main>
</template>
